...
*
* AZERTY DCS subset of ligatures.
*
* Copyright:
...
*
* History:
* Adapt to kbfrdcs-ligatures.c             7.0.0.0.0 Thu 2026-08-27T1650+0200
* Copy from kbligazerty.c                  7.0.0.0.0 Mon 2026-08-24T1938+0200

* This file only contains ligatures whose mapping is particular to AZERTY DCS.
