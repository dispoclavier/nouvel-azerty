...
Grand public et développeurs, écrivains, éditeurs, journalistes, programmeurs, rédacteurs, scientifiques, secrétaires, traducteurs, typographes.
                   ...
                   Version : 6.0.6
    Version et nᵒ de build : 6.0.6.00
                      Date : 2025-09-02T1915+0200
...
* Dans le dossier « installer », le sous-dossier « Variantes » contient toute la gamme disponible sous Windows, soit actuellement ce nouvel AZERTY dans « kbfrFRs-6.0.6.00 » ainsi que :
  * Le dossier « kbbrFRs-6.0.6.00 » qui contient la variante AZERTY pour la langue bretonne, avec le trigramme sur la touche du 1, et avec le "ñ" sur la touche du 8 à la place du tiret bas, qui est aussi sur AltGr + J.
  * Le dossier « kbfrPFs-6.0.6.00 » qui contient la variante AZERTY pour la Polynésie française, avec le ʻeta en Minuscule sur la touche du 1, et avec la touche morte macron en Minuscule sur la touche du 8.
  * Le dossier « kbfrAFs-6.0.6.00 » qui contient la variante AZERTY pour l’Afrique francophone, avec l’epsilon latin sur la touche du 1, et avec le o ouvert sur la touche du 8, toujours en Minuscule et en Majuscule.
  * Le dossier « kbfrFRsr-6.0.6.00 » qui contient la variante redisposée de base de ce nouvel AZERTY, disposée en QZJFGY de manière plus ergonomique tout en restant assez proche de l’AZERTY.
...
5. Télécharger le code source de ce nouvel AZERTY depuis [la page d’accueil](https://github.com/dispoclavier/nouvel-azerty/archive/refs/heads/main.zip) ou [la page d’une version](https://github.com/dispoclavier/nouvel-azerty/archive/refs/tags/6.0.6.zip).
