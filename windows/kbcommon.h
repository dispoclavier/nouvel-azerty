...
*
* See VK redefinitions in the locale specific header files.
*
\**********************************************************************************/
/**********************************************************************************\
...
*
* In kbd.h, the macro TYPEDEF_VK_TO_WCHARS is defined for up to 10 shift states
* (1-based) or modification numbers (0-based).
*
* When the Keyboard Table Generation Tool (Unicode) transpiles a KLC file,
* it generates a list based on the assumption that keyboard layouts may use
* up to 56 shift states.
*
* TYPEDEF_VK_TO_WCHARS(11) is for VK_TO_WCHARS11 aVkToWch11[] and so on.
*
\**********************************************************************************/
   TYPEDEF_VK_TO_WCHARS(11)
   TYPEDEF_VK_TO_WCHARS(12)
   TYPEDEF_VK_TO_WCHARS(13)
   TYPEDEF_VK_TO_WCHARS(14)
   TYPEDEF_VK_TO_WCHARS(15)
   TYPEDEF_VK_TO_WCHARS(16)
   TYPEDEF_VK_TO_WCHARS(17)
   TYPEDEF_VK_TO_WCHARS(18)
   TYPEDEF_VK_TO_WCHARS(19)
   TYPEDEF_VK_TO_WCHARS(20)
   TYPEDEF_VK_TO_WCHARS(21)
   TYPEDEF_VK_TO_WCHARS(22)
   TYPEDEF_VK_TO_WCHARS(23)
   TYPEDEF_VK_TO_WCHARS(24)
   TYPEDEF_VK_TO_WCHARS(25)
   TYPEDEF_VK_TO_WCHARS(26)
   TYPEDEF_VK_TO_WCHARS(27)
   TYPEDEF_VK_TO_WCHARS(28)
   TYPEDEF_VK_TO_WCHARS(29)
   TYPEDEF_VK_TO_WCHARS(30)
   TYPEDEF_VK_TO_WCHARS(31)
   TYPEDEF_VK_TO_WCHARS(32)
   TYPEDEF_VK_TO_WCHARS(33)
   TYPEDEF_VK_TO_WCHARS(34)
   TYPEDEF_VK_TO_WCHARS(35)
   TYPEDEF_VK_TO_WCHARS(36)
   TYPEDEF_VK_TO_WCHARS(37)
   TYPEDEF_VK_TO_WCHARS(38)
   TYPEDEF_VK_TO_WCHARS(39)
   TYPEDEF_VK_TO_WCHARS(40)
   TYPEDEF_VK_TO_WCHARS(41)
   TYPEDEF_VK_TO_WCHARS(42)
   TYPEDEF_VK_TO_WCHARS(43)
   TYPEDEF_VK_TO_WCHARS(44)
   TYPEDEF_VK_TO_WCHARS(45)
   TYPEDEF_VK_TO_WCHARS(46)
   TYPEDEF_VK_TO_WCHARS(47)
   TYPEDEF_VK_TO_WCHARS(48)
   TYPEDEF_VK_TO_WCHARS(49)
   TYPEDEF_VK_TO_WCHARS(50)
   TYPEDEF_VK_TO_WCHARS(51)
   TYPEDEF_VK_TO_WCHARS(52)
   TYPEDEF_VK_TO_WCHARS(53)
   TYPEDEF_VK_TO_WCHARS(54)
   TYPEDEF_VK_TO_WCHARS(55)
   TYPEDEF_VK_TO_WCHARS(56)
/**********************************************************************************\
