...
default partial xkb_types "dispocla" {
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_GROUP1" {
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_HYBRID_GROUP1" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_GROUP1.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_HYBRID_GROUP1" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_GROUP1.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_HYBRID_GROUP1" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on most base letter keys in variants that have graphic
		// letters remapped while shortcut letters stay the legacy way.
		//
		// Control for application shortcuts is mapped to index 8.
		// See “Mapping application shortcuts in keyboard layouts”.
	...
	type "EIGHT_LEVELS_SEMIALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on AC01 or whatever key the letter Q is mapped to.
	...
	type "EIGHT_LEVELS_SEMIALPHABETIC_HYBRID_GROUP1" {
		// Based on EIGHT_LEVELS_SEMIALPHABETIC.
		// Used on AD01 or whatever key the letter Q is mapped to.
	...
	type "EIGHT_LEVELS_DIGIT_GROUP1" {
		// Used on Canadian variants, keys AE01..AE06.
		...
		level_name[ Level8 ] = "Majuscule (chiffres verrouillées)";
	...
	type "EIGHT_LEVELS_AD11_GROUP1" {
		// Based on EIGHT_LEVELS_LEVEL_ONE_LOCK.

		modifiers =                  Control + LevelFive + LevelThree + Shift;
		map[ None                                                             ] = Level1; // <ê>
		map[                                                            Shift ] = Level4; // ‹
		map[                                               LevelThree         ] = Level3; // <ẽ>
		map[                                               LevelThree + Shift ] = Level6; // ^
		map[                                   LevelFive                      ] = Level2; // ‹ 
		map[                                   LevelFive              + Shift ] = Level7; // <ë>
		map[                                   LevelFive + LevelThree         ] = Level5; // C
		map[                                   LevelFive + LevelThree + Shift ] = Level8; // [
		map[                         Control                                  ] = Level8; // [
		map[                         Control                          + Shift ] = Level8; // [
		preserve[                    Control                                  ] = Control;
		...
		level_name[ Level3 ] = "AltGr";
		level_name[ Level4 ] = "Majuscule";
		level_name[ Level5 ] = "Majuscule + AltFr";
		level_name[ Level6 ] = "Base (chiffres verrouillés)";
		level_name[ Level7 ] = "Majuscule + AltGr";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr";

	};

	type "EIGHT_LEVELS_AD11_FIRSTALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_AD12_FIRSTALPHABETIC and EIGHT_LEVELS_AD11.
		// Used on Swiss variant.
		...
		level_name[ Level5 ] = "AltFr";
		level_name[ Level6 ] = "AltGr + AltFr";
		level_name[ Level7 ] = "AltGr (chiffres verrouillés)";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr (chiffres verrouillés)";

	};

	type "EIGHT_LEVELS_AD12_GROUP1" {
		// Based on EIGHT_LEVELS_AD11.
		...
		map[                                   LevelFive                      ] = Level2; //  ›
		map[                                   LevelFive              + Shift ] = Level7; // £
		map[                                   LevelFive + LevelThree         ] = Level5; // D
		map[                                   LevelFive + LevelThree + Shift ] = Level8; // ]
		map[                         Control                                  ] = Level8; // ]
		map[                         Control                          + Shift ] = Level8; // ]
		preserve[                    Control                                  ] = Control;
	...
	type "EIGHT_LEVELS_AD12_FIRSTALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_PUNCTUATION_FIRSTALPHABETIC and EIGHT_LEVELS_AD12.
		// Used on Canadian multilingual.
		...
		level_name[ Level5 ] = "AltFr";
		level_name[ Level6 ] = "AltGr + AltFr";
		level_name[ Level7 ] = "AltGr + AltFr (majuscules verrouillées)";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr";

	};

	type "EIGHT_LEVELS_AC11_GROUP1" {
		// Based on EIGHT_LEVELS_AD11.
		...
		map[                                   LevelFive                      ] = Level2; // « 
		map[                                   LevelFive              + Shift ] = Level7; // %
		map[                                   LevelFive + LevelThree         ] = Level5; // A
		map[                                   LevelFive + LevelThree + Shift ] = Level8; // '
		map[                         Control                                  ] = Level8; // '
		map[                         Control                          + Shift ] = Level8; // '
		preserve[                    Control                                  ] = Control;
	...
	type "EIGHT_LEVELS_AC11_ONEALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_AC11.
		// May be used on AC11 with a casing letter on index 1.
		// Rather than passing level 1 letter on to internal capitalization when CapsLock is on.
		// Requires index 6 to yield the uppercase.
		...
		map[                  Lock                       + LevelThree         ] = Level3; // 
		map[                  Lock                       + LevelThree + Shift ] = Level7; // 
		map[                  Lock           + LevelFive                      ] = Level2; // 
		map[                  Lock           + LevelFive              + Shift ] = Level5; // 
		map[                  Lock           + LevelFive + LevelThree         ] = Level7; // 
		map[                  Lock           + LevelFive + LevelThree + Shift ] = Level8; // 
		map[                         Control                                  ] = Level8; // 
		...
		level_name[ Level4 ] = "Majuscule";
		level_name[ Level5 ] = "Majuscule + AltFr";
		level_name[ Level6 ] = "Base (majuscules verrouillés)";
		level_name[ Level7 ] = "Majuscule + AltGr";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr";

	};

	type "EIGHT_LEVELS_AC11_FIRSTALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_PUNCTUATION_FIRSTALPHABETIC and EIGHT_LEVELS_AC11.
		// Used on Canadian variants.
		...
		level_name[ Level4 ] = "Majuscule + AltGr";
		level_name[ Level5 ] = "AltFr";
		level_name[ Level6 ] = "aucun";
		level_name[ Level7 ] = "AltGr + AltFr";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr";

	};

	type "EIGHT_LEVELS_BKSL_GROUP1" {
		// Based on EIGHT_LEVELS_AC11.
		// Used on BKSL = ISO key position C12. (ANSI: backslash on D13.)
		...
		map[                                   LevelFive                      ] = Level2; //  »
		map[                                   LevelFive              + Shift ] = Level7; // µ
		map[                                   LevelFive + LevelThree         ] = Level5; // B
		map[                                   LevelFive + LevelThree + Shift ] = Level8; // ;
		map[                         Control                                  ] = Level8; // ;
		map[                         Control                          + Shift ] = Level8; // ;
		preserve[                    Control                                  ] = Control;
	...
	type "EIGHT_LEVELS_BKSL_REMAP_GROUP1" {
		// Based on EIGHT_LEVELS_BKSL.
		// Used on BKSL = ISO key position C12. (ANSI: backslash on D13.)
	...
	type "EIGHT_LEVELS_BKSL_CA_GROUP1" {
		// Based on EIGHT_LEVELS_BKSL.
	...
	type "EIGHT_LEVELS_BKSL_FIRSTALPHABETIC_GROUP1" {
		// Based on EIGHT_LEVELS_AC11_ONEALPHABETIC and EIGHT_LEVELS_BKSL_CA.
		// Used on Canadian multilingual variant.
	...
	type "EIGHT_LEVELS_PUNCTUATION_ONE_GROUP1" {
		// Used on AB07.
		...
		level_name[ Level6 ] = "Majuscule + AltFr (chiffres verrouillés)";
		level_name[ Level7 ] = "AltGr + AltFr";
		level_name[ Level8 ] = "Majuscule + AltGr + AltFr";

	};

	type "EIGHT_LEVELS_PUNCTUATION_TWO_GROUP1" {
	...
	type "EIGHT_LEVELS_SPACEBAR_GROUP1" {
		// The spacebar has a peculiar position mapping in Programmer mode.

		modifiers =                  Control + LevelFive + LevelThree + Shift;
		map[ None                                                             ] = Level1; // breaking justifying space U+0020
		map[                                                            Shift ] = Level1; // breaking justifying space U+0020
		map[                                               LevelThree         ] = Level2; // non-breaking justifying space U+00A0
		map[                                               LevelThree + Shift ] = Level4; // ZERO WIDTH SPACE U+200B
		map[                                   LevelFive                      ] = Level3; // non-breaking thin space U+202F
		map[                                   LevelFive              + Shift ] = Level5; // non-breaking justifying space emulation U+0020 U+2060
		map[                                   LevelFive + LevelThree         ] = Level6; // non-breaking justifying legacy space emulation U+0020 U+FEFF
		map[                                   LevelFive + LevelThree + Shift ] = Level7; // '&nbsp;'
		map[                         Control                                  ] = Level1; // 
		map[                         Control                          + Shift ] = Level1; // 
		preserve[                    Control                                  ] = Control;
		...
		level_name[ Level3 ] = "AltFr";
		level_name[ Level4 ] = "Majuscule + AltGr";
		level_name[ Level5 ] = "Majuscule + AltFr";
		level_name[ Level6 ] = "AltGr + AltFr";
		level_name[ Level7 ] = "Majuscule + AltGr + AltFr";
		level_name[ Level8 ] = "AltGr + AltFr (chiffres verrouillés)";
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_HYBRID_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SIX_TITLECASE_GROUP2.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_HYBRID_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC_LEVEL_SEVEN_ALPHABETIC_GROUP2.
		// Used on AD02.
	...
	type "EIGHT_LEVELS_FIRSTALPHABETIC_HYBRID_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on most base letter keys in variants that have graphic
		// letters remapped while shortcut letters stay the legacy way.
		//
	...
	type "EIGHT_LEVELS_SEMIALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_FIRSTALPHABETIC.
		// Used on AC01 or whatever key the letter Q is mapped to.
	...
	type "EIGHT_LEVELS_SEMIALPHABETIC_HYBRID_GROUP2" {
		// Based on EIGHT_LEVELS_SEMIALPHABETIC.
		// Used on AD01 or whatever key the letter Q is mapped to.
	...
	type "EIGHT_LEVELS_DIGIT_GROUP2" {
		// Used on Canadian variants, keys AE01..AE06.
		...
		map[                                   LevelFive              + Shift ] = Level6; // 
		map[                                   LevelFive + LevelThree         ] = Level5; // 
		map[                                   LevelFive + LevelThree + Shift ] = Level1; // 
		map[                         Control                                  ] = Level1; // 
		map[                         Control                          + Shift ] = Level1; // 
		preserve[                    Control                                  ] = Control;
		preserve[                    Control                          + Shift ] = Control + Shift;
	...
	type "EIGHT_LEVELS_AD11_FIRSTALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_AD12_FIRSTALPHABETIC and EIGHT_LEVELS_AD11.
		// Used on Swiss variant.
	...
	type "EIGHT_LEVELS_AD12_FIRSTALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_PUNCTUATION_FIRSTALPHABETIC and EIGHT_LEVELS_AD12.
		// Used on Canadian multilingual.
	...
	type "EIGHT_LEVELS_AC11_ONEALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_AC11.
		// May be used on AC11 with a casing letter on index 1.
		// Rather than passing level 1 letter on to internal capitalization when CapsLock is on.
		// Requires index 6 to yield the uppercase.
	...
	type "EIGHT_LEVELS_AC11_FIRSTALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_PUNCTUATION_FIRSTALPHABETIC and EIGHT_LEVELS_AC11.
		// Used on Canadian variants.
	...
	type "EIGHT_LEVELS_BKSL_REMAP_GROUP2" {
		// Based on EIGHT_LEVELS_BKSL.
		// Used on BKSL = ISO key position C12. (ANSI: backslash on D13.)
	...
	type "EIGHT_LEVELS_BKSL_CA_GROUP2" {
		// Based on EIGHT_LEVELS_BKSL.
	...
	type "EIGHT_LEVELS_BKSL_FIRSTALPHABETIC_GROUP2" {
		// Based on EIGHT_LEVELS_AC11_ONEALPHABETIC and EIGHT_LEVELS_BKSL_CA.
		// Used on Canadian multilingual variant.
	...
	type "EIGHT_LEVELS_PUNCTUATION_ONE_GROUP2" {
		// Used on AB07.
		...
		map[                                               LevelThree + Shift ] = Level4; // <ç>
		map[                                   LevelFive                      ] = Level1; // ,
		map[                                   LevelFive              + Shift ] = Level5; // &#x
		map[                                   LevelFive + LevelThree         ] = Level6; //   digitspace
		map[                                   LevelFive + LevelThree + Shift ] = Level8; // 😢
		map[                         Control                                  ] = Level1; // ,
		map[                         Control                          + Shift ] = Level1; // ,
		preserve[                    Control                                  ] = Control;
	...
	type "EIGHT_LEVELS_SPACEBAR_GROUP2" {
		// The spacebar has a peculiar position mapping in Programmer mode.
		...
		map[                                   LevelFive + LevelThree         ] = Level8; // '&#x202F;'
		map[                                   LevelFive + LevelThree + Shift ] = Level7; // '&nbsp;'
		map[                         Control                                  ] = Level1; // 
		map[                         Control                          + Shift ] = Level1; // 
		preserve[                    Control                                  ] = Control;
