...
* Transformations :
	* Groupes des symboles :
		...
		* Mouvoir "∪" U+222A du groupe 4 de "'" au groupe 4 de "&" pour maintenir la mnémonique basée sur "U", à la place de "⛱" U+26F1, qui va dans le groupe 4 de "}" à la place de "⭕" U+2B55, qui va dans le groupe 4 de "{" à la place de "∩" U+2229, qui va dans le groupe 4 de "'" à la place laissée par "∪" U+222A. compose-3.yml []()
