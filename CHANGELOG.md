...
Pour assurer l’affichage d’un maximum de caractères, il est nécessaire d’avoir [installé des polices complètes](https://support.microsoft.com/fr-fr/office/ajouter-une-police-b7c5f17c-4426-4b53-967f-455339c564c1) : [BabelStone Han](https://www.babelstone.co.uk/Fonts/Han.html), [Code2000](https://en.wikipedia.org/wiki/Code2000), DejaVuSans ([Font Squirrel](https://www.fontsquirrel.com/fonts/dejavu-sans)), Kelvinch ([1001 Fonts](https://www.1001fonts.com/kelvinch-font.html)), NishikiTeki ([Fontspace](https://www.fontspace.com/nishiki-teki-font-f86893)).
