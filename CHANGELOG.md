...
Version 3.0 parce que les exposants changent de niveau, d’AltGr + AltFr à Maj + AltFr, afin que la majuscule du trigramme breton puisse être saisie en ajoutant Maj, non en ajoutant AltGr, sur Maj + AltGr + AltFr, et pour faciliter la saisie des minuscules en exposant, en Maj + AltFr, non en AltGr + AltFr.
...
* Supprimer la prise en charge du digramme breton, non disposé. (compose-1.yml [1f3776e](https://github.com/dispoclavier/nouvel-azerty/commit/1f3776e536fbe430d3ecd064c237eb1a47dc4816))
* Rectifier la documentation. (ibidem)
...
* Transformations :
	...
	* Sélectrice de groupe : Déboguer les caractères morts "①" U+2460 à "⑫" U+246B. (ibidem)
...
* Composition :
	...
	* Ajouter le caractère de "▮" openrectbullet # U+25AE. (compose-1.yml [c1d9ec1](https://github.com/dispoclavier/nouvel-azerty/commit/c1d9ec15431e67f09f93d1b81f52ffa866207b7c))
