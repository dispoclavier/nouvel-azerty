...
//            Particularités : Redisposition pour agencement ANSI sans la touche [<>], avec AltFr sur Verrouillage Majuscule, et le Verrouillage des capitales sur Contrôle droite.
//
