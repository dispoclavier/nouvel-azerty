...
//            Particularités : Redisposition pour agencement ANSI en AZERTY, avec AltFr sur Verrouillage Majuscule, et le Verrouillage des capitales sur la touche [<>] de l’AZERTY à la place de Contrôle droite, avec Effacement arrière sur Menu, et Menu sur Effacement arrière.
//
