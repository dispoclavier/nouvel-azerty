	...
	if ( $math_flag ) {
		if ( $line =~ /^</ ) {
			unless ( $line =~ /<nobreakspace>/ ) {
				...
				$line =~ s/ {2,}/ /g;
				$line =~ s/> </></g;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$10<\/td><td>U+$11<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td>$5<\/td><td>$6<\/td><td>$7<\/td><td>$8<\/td><td>$9<\/td><td>$12<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$9<\/td><td>U+$10<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td>$5<\/td><td>$6<\/td><td>$7<\/td><td>$8<\/td><td><\/td><td>$11<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$8<\/td><td>U+$9<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td>$5<\/td><td>$6<\/td><td>$7<\/td><td><\/td><td><\/td><td>$10<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$7<\/td><td>U+$8<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td>$5<\/td><td>$6<\/td><td><\/td><td><\/td><td><\/td><td>$9<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$6<\/td><td>U+$7<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td>$5<\/td><td><\/td><td><\/td><td><\/td><td><\/td><td>$8<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$5<\/td><td>U+$6<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td>$4<\/td><td><\/td><td><\/td><td><\/td><td><\/td><td><\/td><td>$7<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)> : "(.+?)" U(....) # (.+)/<tr><td>$4<\/td><td>U+$5<\/td><td>$1<\/td><td>$2<\/td><td>$3<\/td><td><\/td><td><\/td><td><\/td><td><\/td><td><\/td><td><\/td><td>$6<\/td><\/tr>/;
				print OUTPUT "$line";
			}
		}
	}
