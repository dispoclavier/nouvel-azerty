	...
	if ( $math_flag ) {
		if ( $line =~ /^</ ) {
			unless ( $line =~ /<nobreakspace>/ || $line =~ /<rightsinglequotemark>/ ) {
				...
				$line =~ s/ {2,}/ /g;
				$line =~ s/> </></g;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$10<\/td><td>U+$11<\/td><td>$1$2$3$4$5$6$7$8$9<\/td><td>$12<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$10<\/td><td>U+$11<\/td><td>$1$2$3$4$5$6$7$8$9<\/td><td>$12<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$9<\/td><td>U+$10<\/td><td>$1$2$3$4$5$6$7$8 <\/td><td>$11<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$9<\/td><td>U+$10<\/td><td>$1$2$3$4$5$6$7$8 <\/td><td>$11<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$8<\/td><td>U+$9<\/td><td>$1$2$3$4$5$6$7  <\/td><td>$10<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$8<\/td><td>U+$9<\/td><td>$1$2$3$4$5$6$7  <\/td><td>$10<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$7<\/td><td>U+$8<\/td><td>$1$2$3$4$5$6   <\/td><td>$9<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$7<\/td><td>U+$8<\/td><td>$1$2$3$4$5$6   <\/td><td>$9<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$6<\/td><td>U+$7<\/td><td>$1$2$3$4$5    <\/td><td>$8<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$6<\/td><td>U+$7<\/td><td>$1$2$3$4$5    <\/td><td>$8<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$5<\/td><td>U+$6<\/td><td>$1$2$3$4     <\/td><td>$7<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$5<\/td><td>U+$6<\/td><td>$1$2$3$4     <\/td><td>$7<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)> : "(.+?)" U(20[DE][0-9A-F]) # (.+)/<tr><td>◌$4<\/td><td>U+$5<\/td><td>$1$2$3      <\/td><td>$6<\/td><\/tr>/;
				$line =~ s/^<(.+?)><(.+?)><(.+?)> : "(.+?)" U([0-9A-F]{4}) # (.+)/<tr><td>$4<\/td><td>U+$5<\/td><td>$1$2$3      <\/td><td>$6<\/td><\/tr>/;
				print OUTPUT "$line";
			}
		}
	}
