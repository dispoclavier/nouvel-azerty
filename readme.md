...
À l’heure où le mot d’ordre est d’éponger la dette publique, tous les gains de productivité sont les bienvenus. Aussi ce nouvel AZERTY vient-il à point nommé, car il élimine les tâches fastidieuses jusqu’à présent synonymes de production de textes utilisables, prêts à diffuser. Ces économies doivent contribuer à rembourser la [hausse du déficit due au confinement](https://www.vie-publique.fr/en-bref/281423-covid-19-le-cout-de-la-crise-sanitaire-pour-letat) faute de [masques suite au démantèlement de Plaintel](https://www.francetvinfo.fr/sante/maladie/coronavirus/enquete-franceinfo-comment-la-france-a-sacrifie-sa-principale-usine-de-masques-basee-en-bretagne_3896665.html), pénurie et crise sanitaire qui ont [pris la France à l’improviste comme « une espèce de bombe atomique »](https://www.francetvinfo.fr/sante/maladie/coronavirus/video-coronavirus-le-nombre-de-contaminations-lors-du-rassemblement-evangelique-de-mulhouse-a-ete-largement-sous-evalue_3889133.html) <span id=aveu1></span>faute de l’alerte précoce que la personne derrière ce nouvel AZERTY a manqué de lancer en février 2017. D’où son obligation d’aider la France coûte que coûte à augmenter sa productivité.

Ce nouvel AZERTY permet en effet d’écrire facilement en [français interopérable](https://blog.dispoclavier.eu/2020/05/19/ecriture-du-francais/#25-ecrire-en-francais-interoperable), avec les grandes ponctuations espacées et les chiffres groupés selon l’Imprimerie nationale, [Le Robert](https://dictionnaire.lerobert.com/guide/ponctuation-et-espace) et [Unicode](https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-6/#G26915) par l’espace fine insécable U+202F, que l’industrie graphique française a massivement adoptée depuis sa sortie dans Unicode 3.0 en 1999, et qui est prise en charge par le CLDR d’Unicode depuis sa [version 34 (2018)](https://cldr.unicode.org/downloads/cldr-34#h.q1mr39yetx2z_l), en même temps que les indicateurs ordinaux "ᵈ", "ᵉ", "ʳ" et "ˢ", recommandés par l’[Académie française](https://www.academie-francaise.fr/abreviations-des-adjectifs-numeraux) et pareillement pris en charge par le [CLDR](https://github.com/unicode-org/cldr/blob/01d3fe0c2168336453b5ec1a34837da1ba9fbc6c/common/main/fr.xml#L1528), dont le plus fréquent, "ᵉ", est en AltGr en synergie avec les chiffres.

L’espacement des grandes ponctuations " ? ; : !«  »‹  ›" est source de prise de tête, de complications, d’ennuis, de frustrations et de pertes de productivité quand on ne se donne pas le moyen de le faire efficacement, avec l’espace fine insécable. Avec ce nouvel AZERTY Dispoclavier on a pour la première fois une disposition de clavier rapide et complète qui fonctionne aussi bien pour le français que pour les autres langues, dont aucune n’a eu l’idée d’espacer les grandes ponctuations sauf le mongolien, qui a aussi son écriture, l’écriture mongole, dont les polices de caractères ont les ponctuations déjà espacées, contrairement à l’écriture latine qui sert à beaucoup de langues dont aucune n’a eu l’idée d’espacer des ponctuations, sauf le français.

Est facilitée aussi l’écriture selon [une préconisation de l’Académie française](https://www.academie-francaise.fr/questions-de-langue#5_strong-em-accentuation-des-majuscules-em-strong) avec [majuscules diacritées](https://fr.wikipedia.org/wiki/AZERTY#:~:text=Une%20extension,leur%20version%20minuscule%2E), dont les plus courantes sont en Majuscule, de même que l’écriture en capitales diacritées, en Verrouillage Capitales pour autant que leurs minuscules ont une touche vive sur l’AZERTY. Cela tranche avec le niveau de service fourni par l’AZERTY de la norme de clavier NF Z71‑300:2019, sans gaspiller de place pour une touche "ê", [émulée](#émulation-de-touche-ê) par la touche morte accent circonflexe, dont la position reste inchangée.

Cela dit, rien n’oblige à utiliser ces nouvelles fonctionnalités, car l’écriture traditionnelle ou en langues étrangères sans espaces fines est tout aussi simple, grâce à la nouvelle modificatrice « AltFr » sur la touche ⟦><⟧ entre Majuscule et ⟦W⟧, ou sur Verrouillage Capitales qui passe alors sur ⟦><⟧ ou sur Contrôle droite (où certains agencements ont la touche ⟦><⟧).

Ce nouvel AZERTY est la disposition de base au sein d’un ensemble de dispositions de clavier adaptées aux langues nationales, régionales et voisines de la Francophonie, notamment au breton, aux langues de Polynésie, au bambara et à d’autres langues d’Afrique francophone. Toutes prennent en charge l’espacement des grandes ponctuations avec l’espace fine insécable selon [la typographie française nouvelle école](https://dispoclavier.com/nouvel-azerty/#source-2250-1-39). L’espacement [vieille école](https://dispoclavier.com/nouvel-azerty/#source-2250-1-43) manuel du deux-points est facilité pour une saisie de texte selon la pratique de l’Imprimerie nationale, qui applique déjà l’espacement nouvelle école aux guillemets chevrons.
...
Plus généralement, toutes les lettres accentuées ou autrement diacritées sont dans les touches mortes, dont les deux les plus traditionnelles, l’accent circonflexe et le tréma, sont l’une à sa place historique, l’autre pareillement en Minuscule mais sur la touche ⟦5([⟧, au lieu de rester en Majuscule sur la touche de l’accent circonflexe, cette place étant utilisée pour le guillemet français simple ouvrant. Mais en mode français, la touche morte tréma y reste accessible en Maj + AltFr pour la rétrocompatibilité.

Les deux autres touches mortes de l’AZERTY traditionnel, qui ont fait leur entrée après l’avènement de l’AZERTY d’ordinateur, l’accent grave et le tilde, sont toujours en AltGr mais sur la touche de l’accent circonflexe pour le tilde, et sur la touche ⟦£$¤⟧ pour l’accent grave. Car en Minuscule, c’est la touche morte accent aigu, qui sert aussi à la saisie des [guillemets apostrophes](#guillemets-de-distanciation) fermants doubles et simples, les ouvrants étant dans la touche morte accent circonflexe. Toutefois, pour la rétrocompatibilité, les touches mortes tilde et accent grave sont aussi sur leurs touches historiques, en Maj + AltGr en mode français, sous des formes rétrocompatibles qui émettent des symboles ASCII quand on fait suivre un appui sur la barre d’espace ou qu’on appuie deux fois sur l’une de ces touches mortes. Celles-ci sont destinées uniquement à assurer un maximum de rétrocompatibilité.

Par ailleurs, toutes les 30 touches mortes diacritiques ou transformationnelles sont disposées en Maj + AltGr, chacune sur la touche de son parent ASCII (qui sous Linux est son équivalent en composition), sauf la touche morte grec ou cerclé sur ⟦Y⟧, disposée aussi en AltGr à la place de son parent ASCII, l’arobase, qui est disposée en Minuscule sur ⟦°)]⟧. Les autres touches mortes transformationnelles appliquent elles aussi des transformations aux lettres et aux chiffres plutôt que d’ajouter des diacritiques. Partiellement cela est aussi le cas des touches mortes diacritiques, comme pour la saisie des [guillemets apostrophes](#guillemets-de-distanciation). Elles sont toutes documentées sur [la page des touches mortes](https://dispoclavier.com/nouvel-azerty/touches-mortes/), sauf les lettres grecques diacritées, documentées uniquement sur [la page de la touche morte grec ou cerclé](https://dispoclavier.com/nouvel-azerty/touches-mortes/grec-ou-cercle/#1564-lettres-grecques-diacritees).

### Touche morte groupe

La touche morte groupe s’appelle aussi « touche groupe ». Elle est notée « ① » et disposée sur ⟦µ*⟧ en Minuscule et en AltGr.

La touche groupe met la disposition dans le groupe 1. Il y a les lettres françaises "œ" et "æ", de nombreuses autres lettres documentées dans [ce tableau](https://dispoclavier.com/nouvel-azerty/touches-mortes/groupe/#groupes-des-lettres), le point médian sur ⟦P⟧ en Minuscule et en Majuscule, le symbole litre « ℓ » sur ⟦L⟧ en Majuscule, les demi-anneaux gauche « ʿ » et droit « ʾ » sur ⟦L⟧ et ⟦M⟧ en Minuscule, les symboles verset « ℣ » et répons « ℟ » sur ⟦V⟧ et ⟦R⟧, et les symboles documentés dans [ce tableau](https://dispoclavier.com/nouvel-azerty/touches-mortes/groupe/#groupes-des-symboles).
...
La première utilité de la touche de composition est la saisie des fractions précomposées. "½" est « ¦12 » ou « ¦1/2 ».
...
D’autres symboles ASCII sont disposés sur les places vacantes avec des mnémoniques alphabétiques ou graphiques : la perluète "&" sur ⟦P⟧, le croisillon "#" sur ⟦Q⟧, le symbole pour cent "%" sur ⟦Z⟧, le circonflexe ASCII "^" sur ⟦A⟧, le tilde "~" sur ⟦T⟧, la contre-oblique "\\" sur ⟦R⟧, la barre verticale ou tuyau "|" sur ⟦M⟧ parce que c’est le parent ASCII de la touche morte macron, le symbole égal "=" sur ⟦B⟧, l’accent grave ASCII "`" sur ⟦N⟧, le tiret-moins "-" sur ⟦G⟧, le signe plus "+" sur ⟦H⟧, et enfin le tiret bas "_" sur ⟦J⟧, et l’apostrophe ASCII "'" sur ⟦U⟧.
...
* En mode français, elles sont en Majuscule avec espace, et en AltFr sans espace. Toutes sauf le point d’exclamation sont aussi en AltGr. Le point d’exclamation cède sa place en AltGr au symbole paragraphe, afin que celui-ci reste en synergie avec les chiffres, pour la rétrocompatibilité avec le symbole paragraphe de l’AZERTY traditionnel, où il est pareillement en synergie avec les chiffres (sauf que c’est en Majuscule).
