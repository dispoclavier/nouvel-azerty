...
Télécharger le dossier « [Un-nouvel-AZERTY-Windows-5.3.0.zip](https://github.com/dispoclavier/nouvel-azerty/releases/download/5.3.0/Un-nouvel-AZERTY-Windows-5.3.0.zip) » sous le titre « Assets », l’extraire, aller dans le dossier « kbfrFRs-5.3.0.26-installation » et procéder comme indiqué dans le Lisez-moi-svp.txt. Une fois fini, il faut redémarrer l’ordinateur pour que la nouvelle disposition apparaisse dans la barre des langues près de l’horloge dans la barre des tâches.
